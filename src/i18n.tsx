...
export const ui = {
  en: {
    ...
    archiveSectors: "Archive pages",
    previousSector: "Load previous archive page",
    nextSector: "Load next archive page",
  },
  es: {
    ...
    archiveSectors: "Páginas del archivo",
    previousSector: "Cargar la página anterior del archivo",
    nextSector: "Cargar la página siguiente del archivo",
  },
} as const;
